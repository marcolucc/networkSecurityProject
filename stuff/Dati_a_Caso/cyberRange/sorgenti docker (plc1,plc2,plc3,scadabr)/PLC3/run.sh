#!/bin/bash
SQL_SCRIPT="INSERT INTO Programs (Name, Description, File, Date_upload) VALUES ('PLC3', 'Descrizione', 'PLC3.st', strftime('%s', 'now'));"
...
if ! [[ -f "$FILE" ]]; then
    ...
    cp /home/OpenPLC_v3/scripts/PLC3.st /home/OpenPLC_v3/webserver/st_files
    ...
    echo PLC3.st >> /home/OpenPLC_v3/webserver/active_program
